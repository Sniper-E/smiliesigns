...
/**
 * SIGN_BBCODE_HELP - DO NOT CHANGE
*/
		'ACUTE'				=> '[sign=acute]text[/sign]',
		'AGGRESSIVE'		=> '[sign=aggresive]text[/sign]',
		...
		'POKEEYE'			=> '[sign=pokeeye]text[/sign]',
		...
		'VINSENT'			=> '[sign=vinsent]text[/sign]',
		'WACKO'				=> '[sign=wacko]text[/sign]',
		'WARNING2'			=> '[sign=warning]text[/sign]',
